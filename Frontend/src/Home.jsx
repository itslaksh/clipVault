      ...
      <div className=''>
        <div className='bg-light-BG min-h-screen dark:bg-dark-BG'>
          ...
          <div className='flex px-12 py-7 text-3xl justify-between antialiased'>
            ...
            {/* <button className='font-MavenPro text-xs bg-black px-2 py-1 rounded-full text-white dark:bg-white dark:text-black flex items-center'>Light/Dark</button> */}
          </div>

          <div className="flex items-center m-auto w-[243px] relative border border-black dark:border-white rounded-full antialiased z-10">
            <div
              ref={indicatorRef}
              className="absolute bg-light-Purple dark:bg-dark-Green rounded-full transition-all duration-300 ease-out h-[50px] z-[-1]"
            ...
            <div
              ref={tabRefs.youtube}
              onClick={() => handleTabChange('youtube')}
              className={`py-2 px-4 m-1 font-magra text-2xl cursor-pointer ${activeTab === 'youtube' ? 'text-white dark:text-black' : 'text-gray-500'}`}
            >
              YouTube
            </div>
            ...
            <div
              ...
              className={`py-2 px-4 ml-4 mr-1 font-magra text-2xl cursor-pointer ${activeTab === 'reddit' ? 'text-white dark:text-black' : 'text-gray-500'}`}
            >
              Reddit
            </div>
          </div>
          ...
          <div className="flex items-center select-none justify-center mt-8 text-6xl xs:text-3xl sm:text-5xl md:text-6xl transition-all duration-300">
            <h1
              className={`font-DarkerGro text-light-Purple mr-3 transition-scale duration-300 dark:text-dark-Green  ${isFading ? 'scale-105' : 'scale-100'}`}
            >
          ...
          <div className="flex items-center justify-center mt-14">
            <div className='inline-flex items-center justify-between border p-2 border-black dark:border-white dark:text-white rounded-full antialiased md:min-w-[400px] md:max-w-[600px]'>
              ...
              />
              <button className='bg-light-Purple dark:bg-dark-Green font-MavenPro font-bold text-white dark:text-black rounded-full px-8 py-2 mr-0'>GO!</button>
            </div>
          </div>

          <div
            className={`fixed bottom-[-60px] right-[-60px] w-[350px] h-[350px] translate-x-[45%] translate-y-[45%] bg-no-repeat bg-cover opacity-35 select-none transition-transform duration-300 ${isRotating ? 'rotate-0' : ''}  dark:invert`}
            style={{
